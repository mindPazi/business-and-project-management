...
Pillar~I is load-bearing: the policy mandate, the accountability hierarchy, and the RACI matrix that authorize the other three pillars (detailed in Section~\ref{sec:governance}).
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.78\textwidth]{redaction-demo/output/redacted_document.pdf}}
